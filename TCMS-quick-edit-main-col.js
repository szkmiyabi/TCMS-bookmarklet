javascript:(function(){
	...
	TCMSUtil.prototype = {
		...
		draft_save: function() {
			var btn0 = d.getElementsByClassName("decision-block btn").item(0);
			var btn1 = d.getElementsByClassName("edit-end btn").item(0);
			var btn2 = d.getElementsByClassName("draft-save btn").item(0);
		...
		quick_edit_main_col: function(layout) {
			...
			var icn1 = d.getElementsByClassName(parent_class).item(0);
			if(icn1 !== null) icn1 = icn1.getElementsByClassName("edit-start click").item(0);
			if(icn1 !== null) icn1.click();
			var icn2 = d.getElementsByClassName("block-head").item(0);
